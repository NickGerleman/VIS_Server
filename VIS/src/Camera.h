...
namespace vis
{
	...
	public:
		...
		///
		virtual void clipFrame(const ClipCube& clipCube) = 0;
	...
	public:
		...
		void clipFrame(const ClipCube& clipCube) override;
	...
	class ICamera
	{
		...
		///
		virtual std::unique_ptr<DepthFrame> captureFrame() = 0;
	};
	...
	{
		friend class StructureSensorAccess;
